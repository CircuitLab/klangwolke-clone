...
String mySerialPort = "/dev/tty.usbserial-AD01U7DZ";
XBee xbee = new XBee();
int error = 0;
...
XBeeAddress64[] addresses = {
  new XBeeAddress64(0x0, 0x13, 0xa2, 0x0, 0x40, 0x79, 0xe1, 0x05),
  new XBeeAddress64(0x0, 0x13, 0xa2, 0x0, 0x40, 0x79, 0x2e, 0x75),
  new XBeeAddress64(0x0, 0x13, 0xa2, 0x0, 0x40, 0x79, 0x34, 0x1f),
...
void oscEvent(OscMessage msg)
{
  ...
  if (msg.checkAddrPattern("/tlc")) {
    ...
    println("mode: " + mode + ", device: " + device + ", target1: " + target1 + ", target2: " + target2 + ", value: " + value);
    println("========== MODE = " + mode + " ===========");
